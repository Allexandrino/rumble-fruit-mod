...
public class RumbleHeartsHud {
    private static final ResourceLocation HEART =
            ResourceLocation.fromNamespaceAndPath(RumbleFruitMod.MOD_ID, "textures/gui/lightning_heart.png");

    @SubscribeEvent
    public static void registerOverlays(RegisterGuiLayersEvent event) {
        event.registerAboveAll(ResourceLocation.fromNamespaceAndPath(RumbleFruitMod.MOD_ID, "hearts"),

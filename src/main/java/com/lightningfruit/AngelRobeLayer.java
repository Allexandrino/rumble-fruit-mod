...
public class AngelRobeLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    private static final ResourceLocation ROBE =
            ResourceLocation.fromNamespaceAndPath(LightningFruitMod.MOD_ID, "textures/entity/angel_robe.png");
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(LightningFruitMod.MOD_ID, "angel_robe"), "main");

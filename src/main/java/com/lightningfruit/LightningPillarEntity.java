...
public class LightningPillarEntity extends Entity {
    private static final net.minecraft.network.syncher.EntityDataAccessor<Boolean> HOLY =
            net.minecraft.network.syncher.SynchedEntityData.defineId(LightningPillarEntity.class,
    ...
    public LightningPillarEntity(EntityType<?> type, Level level) {
        super(type, level);
        this.noPhysics = true;
    }
    ...
    public static void summon(ServerLevel level, double x, double y, double z, boolean holy) {
        LightningPillarEntity pillar = new LightningPillarEntity(ModEntities.LIGHTNING_PILLAR.get(), level);
        pillar.setPos(x, y, z);

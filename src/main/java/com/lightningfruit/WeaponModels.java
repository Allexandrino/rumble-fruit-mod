...
public class WeaponModels extends Model {
    public static final ModelLayerLocation SWORD_LAYER =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(LightningFruitMod.MOD_ID, "sword"), "main");
    public static final ModelLayerLocation BOW_LAYER =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(LightningFruitMod.MOD_ID, "bow"), "main");
    public static final ResourceLocation SWORD_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(LightningFruitMod.MOD_ID, "textures/entity/sword_model.png");
    public static final ResourceLocation BOW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(LightningFruitMod.MOD_ID, "textures/entity/bow_model.png");
    public static final ResourceLocation SWORD_HOLY_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(LightningFruitMod.MOD_ID, "textures/entity/sword_model_holy.png");
    public static final ResourceLocation BOW_HOLY_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(LightningFruitMod.MOD_ID, "textures/entity/bow_model_holy.png");
